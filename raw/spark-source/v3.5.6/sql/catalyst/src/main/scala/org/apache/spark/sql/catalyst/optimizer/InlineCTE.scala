...
// source_url: https://github.com/apache/spark/blob/v3.5.6/sql/catalyst/src/main/scala/org/apache/spark/sql/catalyst/optimizer/InlineCTE.scala
...
// logical_unit: InlineCTE rule (logical-stage CTE inlining) (2026-04-26 ingest cycle)
