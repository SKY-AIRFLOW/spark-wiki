...
// source_url: https://github.com/apache/spark/blob/v3.5.6/sql/catalyst/src/main/scala/org/apache/spark/sql/catalyst/plans/physical/partitioning.scala
...
// logical_unit: Distribution + Partitioning 트레이트 및 구현체 전체 파일 (2026-04-26 ingest cycle)
// citation_range (GitHub 원본 행번호): 전체 파일 = lines 1-806
