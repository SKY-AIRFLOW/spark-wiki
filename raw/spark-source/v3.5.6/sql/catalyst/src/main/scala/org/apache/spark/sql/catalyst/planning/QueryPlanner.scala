...
// source_url: https://github.com/apache/spark/blob/v3.5.6/sql/catalyst/src/main/scala/org/apache/spark/sql/catalyst/planning/QueryPlanner.scala
...
// logical_unit: GenericStrategy + QueryPlanner abstract framework — strategies/plan/prunePlans interface (cycle 4 ingest, paper-vs-impl gap)
// citation_range (GitHub 원본 행번호): GenericStrategy=29-39; QueryPlanner abstract docstring (TODO "ONLY ONE PLAN IS RETURNED EVER")=41-54; plan() body=59-95; prunePlans/collectPlaceholders abstract=101,104
