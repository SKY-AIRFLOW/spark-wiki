...
// source_url: https://github.com/apache/spark/blob/v3.5.6/sql/catalyst/src/main/scala/org/apache/spark/sql/catalyst/optimizer/InferWindowGroupLimit.scala
...
// logical_unit: InferWindowGroupLimit rule (rank+limit pattern → WindowGroupLimit logical node insertion) (2026-04-26 ingest cycle)
// citation_range (GitHub 원본 행번호): entire file
