...
// source_url: https://github.com/apache/spark/blob/v3.5.6/sql/catalyst/src/main/scala/org/apache/spark/sql/catalyst/optimizer/joins.scala
// commit_sha: 303c18c74664f161b9b969ac343784c088b47593 (v3.5.6 lightweight tag)
// fetched: 2026-04-19 via curl (raw.githubusercontent.com)
// logical_unit: JoinSelection + JoinSelectionHelper (2026-04-19 ingest cycle)
// citation_range (GitHub 원본 행번호): JoinSelectionHelper trait = lines 286-end
