// ====== Spark Wiki ingest provenance ======
// source_url: https://github.com/apache/spark/blob/v3.5.6/sql/catalyst/src/main/scala/org/apache/spark/sql/catalyst/optimizer/Optimizer.scala
// commit_sha: 303c18c74664f161b9b969ac343784c088b47593 (v3.5.6 lightweight tag)
// fetched: 2026-04-26 via curl (raw.githubusercontent.com)
// logical_unit: PushDownPredicates + ColumnPruning + InferFiltersFromConstraints + Inline CTE batch + defaultBatches wiring (2026-04-26 ingest cycle)
// citation_range (GitHub 원본 행번호): PushDownPredicates obj=1698; PushPredicateThroughNonJoin=1714; PushPredicateThroughJoin=1900; ColumnPruning=866; InferFiltersFromConstraints=1389; InlineCTE batch=159-160; defaultBatches operator rule set=80-150
// line_offset: 이 provenance 헤더 = 8줄. local_line = github_line + 8.
// immutability: ingest 시점 이후 수정 금지 (raw/ 원칙).
/*
