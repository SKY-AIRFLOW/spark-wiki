...
// source_url: https://github.com/apache/spark/blob/v3.5.6/sql/catalyst/src/main/scala/org/apache/spark/sql/catalyst/optimizer/expressions.scala
...
// logical_unit: LikeSimplification (other rules ConstantFolding/BooleanSimplification snapshot for future cycles) (2026-04-26 ingest cycle)
// citation_range (GitHub 원본 행번호): LikeSimplification obj=712; (also: ConstantFolding=47, BooleanSimplification=322, SimplifyConditionals=540, NullPropagation=805 — out of cycle)
