...
// source_url: https://github.com/apache/spark/blob/v3.5.6/sql/core/src/main/scala/org/apache/spark/sql/execution/SparkStrategies.scala
...
// citation_range (GitHub 원본 행번호): JoinSelection object = lines 172-411
