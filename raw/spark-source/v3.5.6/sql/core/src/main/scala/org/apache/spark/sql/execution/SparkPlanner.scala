...
// source_url: https://github.com/apache/spark/blob/v3.5.6/sql/core/src/main/scala/org/apache/spark/sql/execution/SparkPlanner.scala
// commit_sha: 303c18c74664f161b9b969ac343784c088b47593 (v3.5.6 lightweight tag)
// fetched: 2026-04-28 via curl (raw.githubusercontent.com)
// logical_unit: SparkPlanner — concrete planner extending SparkStrategies; strategy registration order + prunePlans no-op (cycle 4 ingest, paper-vs-impl gap)
// citation_range (GitHub 원본 행번호): class header=28-29; numPartitions=31; strategies registration order=33-48; extraPlanningStrategies hook=54; collectPlaceholders=56-60; prunePlans (no-op TODO)=62-66
