...
// source_url: https://github.com/apache/spark/blob/v3.5.6/sql/core/src/main/scala/org/apache/spark/sql/execution/SparkOptimizer.scala
...
// logical_unit: SparkOptimizer batch wiring (where InferWindowGroupLimit + LimitPushDownThroughWindow are added on top of Catalyst defaultBatches) (2026-04-26 ingest cycle)
// citation_range (GitHub 원본 행번호): Infer window group limit batch=88-91; full batch sequence (postHocOptimizationBatches/extendedOptimizationBatches) for context
