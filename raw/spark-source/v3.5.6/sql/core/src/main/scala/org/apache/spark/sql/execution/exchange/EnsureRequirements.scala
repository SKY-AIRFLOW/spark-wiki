...
// source_url: https://github.com/apache/spark/blob/v3.5.6/sql/core/src/main/scala/org/apache/spark/sql/execution/exchange/EnsureRequirements.scala
...
// logical_unit: EnsureRequirements rule 전체 파일 (2026-04-26 ingest cycle)
// citation_range (GitHub 원본 행번호): 전체 파일 = lines 1-629
